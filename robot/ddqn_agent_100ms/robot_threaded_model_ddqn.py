...
class ModelThread(QtCore.QThread):
	...
	def initialize_model(self):
		...
		self.epsilon_decay_final = 0.9999
	...
	def create_model(self):
		...
		model.add(Dense(myinputdim, input_dim=myinputdim, activation='relu'))
		model.add(Dense(myinputdim*0.75, activation='relu'))
