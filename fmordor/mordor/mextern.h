...
/* UPDATE.C */
extern unsigned long timedifference_msec(struct timeval t0, struct timeval t1);
extern unsigned long timedifference_microsec(struct timeval t0, struct timeval t1);
extern unsigned long get_modified_time();
