...
//second timer 
unsigned long timedifference_sec(struct timeval st0, struct timeval t1)
{
	unsigned long tdelta;	
	tdelta =  (t1.tv_sec - st0.tv_sec) ;	
    return tdelta;
}


//milliseocnd timer 
unsigned long timedifference_msec(struct timeval st0, struct timeval t1)
{
	unsigned long tdelta;
	//int tint;
...
//usecond timer 
unsigned long timedifference_microsec(struct timeval st0, struct timeval t1)
{
    return (t1.tv_sec - st0.tv_sec) * 1000000 + (t1.tv_usec - st0.tv_usec) / 1;
}
//modified_time

unsigned long get_modified_time()
{
